...
data = np.load('Data/2D_1250pulse_nx100_ny100_25us.npz')
...
plt.annotate('', xy=(0.77+0.15, 0.65), xycoords='axes fraction',
...
plt.savefig('Figures/2dpulseResQ.eps',dpi=300)

fig = plt.figure(figsize=(5.25,3))
gs = gridspec.GridSpec(1,2, hspace=0.0)
gs.set_width_ratios([0.98,0.02])
ax0 = fig.add_subplot(gs[0,0])
